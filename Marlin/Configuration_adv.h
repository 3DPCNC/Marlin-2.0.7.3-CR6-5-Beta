...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 280*60, 280*60, 80*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE 28             // (mm/s) Default feedrate for retracting
