...
#define STRING_CONFIG_H_AUTHOR "3DPCNC" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 104.58
  #define  DEFAULT_bedKi 11.44
  #define  DEFAULT_bedKd 637.31
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 25, 90 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 300, 15000 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0366      // (mm) Distance from real junction edge
...
#define Z_PROBE_SPEED_FAST ((4 * 50) / 2)  

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_SPEED_SLOW ((Z_PROBE_SPEED_FAST+10) / 2)
